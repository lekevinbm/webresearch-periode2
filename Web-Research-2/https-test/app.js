...
var privateKey = fs.readFileSync('client/ssl/localhost.key','utf8');
var certificate = fs.readFileSync('client/ssl/localhost.crt','utf8');
...
var serv = require('https').createServer(credentials,app);
